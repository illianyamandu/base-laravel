                                ...
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-100">
                                        <div class="flex items-center">
                                            ...
                                            <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2">Cadastrar usuário</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-100">
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-100">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="w-8 h-8 rounded object-cover block">
                                            <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2">Comer morango</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-100">
