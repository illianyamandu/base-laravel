    ...
    <div class="p-6">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4 bg-gray-600" aria-label="Table navigation">
                <span class="ml-2 text-sm font-bold text-gray-500 dark:text-gray-900 mb-4 md:mb-0 block w-full md:inline md:w-auto">Showing <span class="font-semibold text-gray-900 dark:text-white">1-10</span> of <span class="font-semibold text-gray-900 dark:text-white">1000</span></span>
